...
#define MuKOB_VERSION_INFO "v0.1"  // ZZZ get from a central name/version string
...
//
#define ADC_NUM 2
#define ADC_GP (26 + ADC_NUM)

// SPI
//
// uses 3 SPI devices; Display, Touch Panel, SD Card
...
// PIO
// uses PIO for reading the rotary encoder. This narrows the pins that can be used.
