/**
 * Core 1 main start-up and management.
 *
 ...
 *
 * NOTE: Fifo use
 * uses the Fifo for base (core (ha!)) level communication between
 ...
 *
 * acknowledges the warnings, and will take care to assure that the Fifo and
 * the code_seq is in an appropriate state when operations are performed that will
 ...
 *
 * runs the User Interface (UI, aka Frontend/FE) on Core 1, while it
